...
mixin _$AppStore on _AppStore, Store {
  ...
  @override
  ObservableFuture<void> setPlayerId(String val, {bool isInitializing = false}) {
    return ObservableFuture<void>(_$setPlayerIdAsyncAction.run(() => super.setPlayerId(val, isInitializing: isInitializing)));
  }
