                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Marquee(
                            child: Row(
                              children: [
                                PriceWidget(price: bookingDetail.amount.validate(), size: 18, isBoldText: false, color: appTextSecondaryColor),
                                Text(' * ${bookingDetail.quantity != 0 ? bookingDetail.quantity : 1}  = '),
                                PriceWidget(price: bookingDetail.amount.validate(), size: 18, isBoldText: true, color: textPrimaryColorGlobal),
                              ],
                            ),
                          ).flexible(flex: 2),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          Text.rich(TextSpan(children: [
                            TextSpan(text: language.lblDiscount, style: secondaryTextStyle(size: 16)),
                            TextSpan(
